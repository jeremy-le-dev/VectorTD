...
EXE=bin/exec
LIBS=-L./libMac -lEngine -framework OpenGL -framework GLUT -lconfig
LIBSLINUX=  -L./libLinux -lEngine -lGL -lglut -lm -lGLU -lconfig
LIBSWINDOWS= -L./libWin -lEngine -lglu32 -lopengl32  -lglut32 -lconfig
LDFLAGS= -lm -g -lstdc++
